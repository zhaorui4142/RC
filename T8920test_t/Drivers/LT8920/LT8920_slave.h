...
bool LT8920_PairingWaiting(uint8_t ch, uint8_t* nomal_ch, uint32_t waiting_ms);      //从机等待配对
bool LT8920_WaitMastersConnect(void);                                                //从机等待连接
bool LT8920_WaitMastersCommuncation(uint8_t* rx, uint8_t* feedback, uint32_t timeout, uint8_t* lost_count); //从机等待接收
